...
const SCHEMES = [
  ...
  { id:12, category:'Students',        ministry:'Ministry of Minority Affairs',     title:'PM YASASVI Scholarship 2026',         benefit:'₹75,000 – ₹1.25 Lakh',      eligibility:'OBC/EBC/DNT Students Class 9–12',    state:'National', tag:'Scholarship',    docs:['Aadhar Card','Caste Certificate','Income Certificate','Marksheet'],                               portal:'https://scholarships.gov.in' },
  ...
  { id:14, category:'MSME',            ministry:'Ministry of MSME',                 title:'CGTMSE Credit Guarantee 2026',        benefit:'Up to ₹5 Crore Guarantee',   eligibility:'Micro & Small Enterprises',          state:'National', tag:'Guarantee',      docs:['UDYAM Registration','Bank Statement','Business Plan','ITR'],                                      portal:'https://www.cgtmse.in' },
  { id:15, category:'Farmers',         ministry:'Ministry of Agriculture',          title:'Kisan Credit Card 2026',              benefit:'₹3 Lakh @ 4% Interest',      eligibility:'All Farmers & Allied Workers',       state:'National', tag:'Credit',         docs:['Aadhar Card','Land Records','Ration Card','Passport Photo'],                                      portal:'https://pmkisan.gov.in' },
  ...
  { id:19, category:'MSME',            ministry:'Ministry of Commerce',             title:'RoDTEP Scheme 2026',                  benefit:'Tax Rebate on Exports',      eligibility:'Registered Exporters',               state:'National', tag:'Export Benefit', docs:['IEC Code','GST Registration','Bank Account','Shipping Bills'],                                     portal:'https://dgft.gov.in' },
  ...
  // J&K
  { id:21, category:'Students',        ministry:'J&K Government',                   title:'J&K Merit Scholarship 2026',          benefit:'₹12,000 / Year',             eligibility:'J&K Domicile, Top 10% in Class',     state:'J&K',      tag:'Scholarship',    docs:['Domicile Certificate','Aadhar Card','Marksheet','Income Certificate'],                            portal:'https://jkscholarship.nic.in' },
  { id:22, category:'MSME',            ministry:'J&K Industries Department',        title:'J&K New Industrial Policy 2026',      benefit:'30% Capital Subsidy',        eligibility:'New Industrial Units in J&K',        state:'J&K',      tag:'Subsidy',        docs:['Business Registration','Land Allotment Letter','Project Report','GST'],                          portal:'https://jkindustries.gov.in' },
  ...
  { id:24, category:'Women',           ministry:'J&K Mission Youth',                title:'Tejaswini Scheme 2026',               benefit:'₹5 Lakh Interest Free Loan', eligibility:'Women 18-35 for Startups',         state:'J&K',      tag:'Loan',           docs:['Domicile Certificate','Business Plan','Qualification Proof','Aadhar'],                           portal:'https://missionyouth.jk.gov.in' },
  { id:25, category:'Students',        ministry:'J&K Higher Education',             title:'J&K PMSSS (Scholarship)',              benefit:'Full Academic Fee + ₹1L',    eligibility:'J&K/Ladakh Students, XII Passed',    state:'J&K',      tag:'Scholarship',    docs:['XII Marksheet','Income Certificate','Domicile','Aadhar'],                                         portal:'https://aicte-jk-scholarship-gov.in' },
  { id:26, category:'Farmers',         ministry:'J&K Horticulture',                 title:'High Density Plantation Scheme',      benefit:'50% Subsidy on Saplings',    eligibility:'Horticulturists in J&K',             state:'J&K',      tag:'Agriculture',    docs:['Land Ownership','Bank Details','Aadhar','Horticulture Card'],                                    portal:'https://jkhorticulture.nic.in' },
  { id:27, category:'Senior Citizens', ministry:'J&K Social Welfare',             title:'Integrated Social Security Scheme',   benefit:'₹1,000 / Month Pension',     eligibility:'BPL Seniors/Widows/Disabled',        state:'J&K',      tag:'Pension',        docs:['BPL Card','Age Proof','Domicile Certificate','Bank Passbook'],                                   portal:'https://jkswd.nic.in' },

  // DELHI
  { id:28, category:'Students',        ministry:'Delhi Government',                 title:'Delhi Merit Scholarship 2026',        benefit:'₹2,500 / Month',             eligibility:'Delhi Govt School Students, 80%+',   state:'Delhi',    tag:'Scholarship',    docs:['Aadhar Card','School ID','Marksheet','Domicile Certificate'],                                     portal:'https://edudel.nic.in' },
  { id:29, category:'Women',           ministry:'Delhi Government',                 title:'Mukhyamantri Mahila Samman Yojana',   benefit:'₹1,000 / Month',             eligibility:'Delhi Women Age 18+',                state:'Delhi',    tag:'Direct Benefit', docs:['Aadhar Card','Voter ID','Delhi Domicile','Bank Passbook'],                                        portal:'https://delhi.gov.in' },
  { id:30, category:'MSME',            ministry:'Delhi Government',                 title:'Delhi Startup Policy 2026 Grant',     benefit:'₹20 Lakh Seed Grant',        eligibility:'Delhi-based Registered Startups',    state:'Delhi',    tag:'Grant',          docs:['Company Registration','Delhi Address Proof','PAN Card','Pitch Deck'],                             portal:'https://dipp.delhi.gov.in' },

  // PUNJAB
  { id:31, category:'Farmers',         ministry:'Punjab Agriculture Department',    title:'Punjab Kisan Karj Mafi 2026',         benefit:'Loan Waiver up to ₹2 Lakh',  eligibility:'Small & Marginal Punjab Farmers',    state:'Punjab',   tag:'Loan Waiver',    docs:['Land Records','Kisan Credit Card','Aadhar Card','Bank Statement'],                                portal:'https://punjab.gov.in' },
  { id:32, category:'Students',        ministry:'Punjab Government',                title:'Punjab Ashirwad Scholarship',         benefit:'₹21,000 One-time',           eligibility:'SC Girls, Class 1 Admission',        state:'Punjab',   tag:'Scholarship',    docs:['Birth Certificate','SC Certificate','Aadhar Card','School Enrollment'],                           portal:'https://punjabscholarships.gov.in' },
  { id:33, category:'Women',           ministry:'Punjab Government',                title:'Mata Tripta Mahila Yojana',           benefit:'₹18,500 Financial Aid',      eligibility:'Punjab Women BPL Families',          state:'Punjab',   tag:'Direct Benefit', docs:['Aadhar Card','BPL Certificate','Bank Passbook','Domicile'],                                       portal:'https://punjab.gov.in' },

  // HARYANA
  { id:34, category:'Students',        ministry:'Haryana Government',               title:'Haryana Medhavi Chhatra Yojana',      benefit:'₹5,000 – ₹11,000 / Year',   eligibility:'Haryana Students 60%+ in Class 10',  state:'Haryana',  tag:'Scholarship',    docs:['Aadhar Card','Marksheet','Domicile Certificate','Income Certificate'],                            portal:'https://haryana.gov.in' },
  { id:35, category:'Farmers',         ministry:'Haryana Agriculture',              title:'Haryana Krishi Yantra Anudan',        benefit:'40–50% Subsidy on Equipment', eligibility:'Haryana Farmers',                   state:'Haryana',  tag:'Subsidy',        docs:['Land Records','Aadhar Card','Bank Passbook','Equipment Quotation'],                                portal:'https://agriharyana.gov.in' },
];
...
const LAWS = [
  ...
  { id:7, title:'Indian Ports Act, 2026',                           date:'Jan 2026', status:'Enacted',    summary:'Modernises port governance replacing a law from 1908.',                               bullets:['Single regulator for all major and minor ports.','Faster environmental clearances for port expansion.','New framework for private investment in port infrastructure.','Dispute resolution mechanism for port-related conflicts.'] },
  { id:8, title:'Broadcasting Services (Regulation) Bill, 2026',    date:'Nov 2026', status:'Enacted',    summary:'Brings OTT platforms and digital news under broadcasting regulation.',                 bullets:['Netflix, Amazon Prime, YouTube now under content regulation.','Content Evaluation Committees for OTT platforms mandatory.','Self-regulation mechanism for digital news publishers.','Heavy fines for non-compliance with content standards.'] },
  { id:9, title:'Space Activities Bill, 2026',                      date:'Sep 2026', status:'Enacted',    summary:'Opens India\'s space sector to private companies for the first time.',                bullets:['Private companies can now launch satellites and rockets legally.','IN-SPACe acts as the regulator for all space activities.','Liability framework for space debris and satellite collisions.','Technology transfer from ISRO to private sector now permitted.'] },
];
...
const JOBS = [
  { id:1,  title:'Junior Engineer (Civil)',       org:'DRDO',              location:'Delhi',        type:'Government',  category:'Engineer',  deadline:'Jun 2026', link:'https://drdo.gov.in' },
  { id:2,  title:'Agniveer (Army)',               org:'Indian Army',       location:'PAN India',    type:'Defence',     category:'Defence',   deadline:'May 2026', link:'https://joinindianarmy.nic.in' },
  { id:3,  title:'Constable Recruit',             org:'Delhi Police',      location:'Delhi',        type:'Police',      category:'Police',    deadline:'Jun 2026', link:'https://delhipolice.gov.in' },
  { id:4,  title:'Agricultural Field Officer',    org:'NABARD',            location:'Mumbai',       type:'Government',  category:'Farmer',    deadline:'May 2026', link:'https://nabard.org' },
  { id:5,  title:'Staff Nurse',                   org:'AIIMS Delhi',       location:'Delhi',        type:'Healthcare',  category:'Nurse',     deadline:'Jul 2026', link:'https://aiims.edu' },
  { id:6,  title:'Primary Teacher (PRT)',         org:'KVS',               location:'PAN India',    type:'Education',   category:'Teacher',   deadline:'Jun 2026', link:'https://kvsangathan.nic.in' },
  { id:7,  title:'Data Entry Operator',           org:'NIC',               location:'PAN India',    type:'Government',  category:'Engineer',  deadline:'May 2026', link:'https://nic.in' },
  { id:8,  title:'Scientist B (Computer Science)',org:'ISRO',              location:'Bengaluru',    type:'Space',       category:'Engineer',  deadline:'Aug 2026', link:'https://isro.gov.in' },
  { id:9,  title:'Assistant Commandant',          org:'CRPF',              location:'PAN India',    type:'Paramilitary', category:'Defence',  deadline:'Jun 2026', link:'https://crpf.gov.in' },
  { id:10, title:'Junior Hindi Translator',       org:'SSC',               location:'PAN India',    type:'Government',  category:'Teacher',   deadline:'May 2026', link:'https://ssc.nic.in' },
  { id:11, title:'Forest Guard',                  org:'Forest Department', location:'Uttarakhand',  type:'Government',  category:'Defence',   deadline:'Jul 2026', link:'https://uttarakhand.gov.in' },
  { id:12, title:'Research Associate (AI/ML)',    org:'C-DAC',             location:'Pune',         type:'Tech',        category:'Engineer',  deadline:'Jun 2026', link:'https://cdac.in' },
  { id:13, title:'Agniveer (Navy)',               org:'Indian Navy',       location:'PAN India',    type:'Defence',     category:'Defence',   deadline:'May 2026', link:'https://joinindiannavy.gov.in' },
  { id:14, title:'Pharmacist Grade II',           org:'ESIC',              location:'PAN India',    type:'Healthcare',  category:'Nurse',     deadline:'Jun 2026', link:'https://esic.nic.in' },
];
